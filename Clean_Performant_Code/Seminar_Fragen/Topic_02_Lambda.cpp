...
namespace Lambdas {
    ...
    static void test_01()
    {
        ...
        std::sort(
            vec.begin(),
            vec.end(),
            compare       // Strategy Pattern // freien Funktion
        );
    ...
    static void test_02()
    {
        ...
        std::sort(
            vec.begin(),
            vec.end(),
            comparer    // Comparer{ false }  // Aufrufbares Objekt
        );
    ...
    static void test_03()
    {
        ...
        //std::vector<int> vec{ 5, 6, 4, 1, 3, 2, 7, 8 };
        std::vector<double> vec{ 5, 6, 4, 1, 3, 2, 7, 8 };
        ...
        // Go for this line (auto)
        // generischer Lamda
        auto lambda = [](auto n1, auto n2) {
            return n1 < n2;
        };

    //    std::vector<std::function< bool(int, int) >> observer;

        // Dies ist ein Wrapper-Objekt um ein Lambda-Objekt
        std::function< bool (int, int) > func = [](int n1, int n2) {
            return n1 < n2;
        };
        ...
        std::sort(
            vec.begin(),
            vec.end(),
            [=] (auto n1, auto n2) {  // generic lambda: clean & modern
    ...
    static void test_07() {
        ...
        // Very clean // übertrieben

     //   auto variable = 10;

        auto lambda = [variable = 10] () mutable {
            
            //static int variable = 10;  // global variable
            //variable++;
            //return variable; 
    ...
    static auto test_09_helper_b() {
        ...
        auto lambda = [&] {   // Bei Threading: No-Go
            std::cout << "Reference: " << n << " " << m << std::endl;
            };
